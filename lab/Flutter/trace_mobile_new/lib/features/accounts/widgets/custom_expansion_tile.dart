...
class _CustomExpansionTileState extends State<CustomExpansionTile>
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final Color borderSideColor = _borderColor.value ?? Colors.grey.shade300;
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              ...
              // Modified to remove the trailing widget when the property hasChildren is false. Cannot test widget.children.isEmpty because it will always have SizedBox.shrink() widget to maintain the not null status of children widget
