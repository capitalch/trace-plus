    ...
    return (
        <div>
            <button onClick={handleToggleView} id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                ...
                type="button"> Test <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                </svg>
            </button>

            <div id="dropdownDivider"
                className={clsx(cls, "z-10  right-0 absolute top-11 bg-gray-50 divide-y border-[1px] divide-gray-100 rounded-lg  w-56")}>
