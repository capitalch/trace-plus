...
import { setSelectedCategory, setSelectedCatId } from "./filter-control-slice";

export function FilterControl({ catData }: { catData: CategoryType[] }) {
...
//   );
  ...
  const selectedCatId: string | null = useSelector(
    (state: RootStateType) =>
      state.filterControl.filterControlState.selectedCatId
  );
...
//     //   loadData();
//     // } else {
//     //   if (!_.isEmpty(selectedCatId)) {
//     //     dispatch(setSelectedCatId(null));
//     //     setTimeout(() => dispatch(setSelectedCatId(selectedCatId)), 0);
//     //   }
//       //   if (!_.isEmpty(selectedCatOption)) {
//       //     dispatch(setSelectedCategory(null));
//       //     setTimeout(() => dispatch(setSelectedCategory(selectedCatOption)), 0);
//       //   }
//     // }
//   }, [catOptions]);

  const fields: FieldsModel = {
    dataSource: catData as any,
    value: "id",
  ...
  return (
    <div className="p-4 flex flex-col gap-2">
      ...
      <button
        type="button"
        className="px-2 py-1 bg-amber-500 w-40 rounded-lg"
        onClick={() => {
          dispatch(
            setSelectedCategory({
              id: "162",
  ...
  function handleOnChangeCategory(e: DdtSelectEventArgs) {
    ...
    dispatch(setSelectedCatId(item.id));
    // dispatch(
    //   setSelectedCategory({
    //     id: item.id,
    //     parentId: item.ID,
...
const brands = [
  ...
  { id: 111, brandName: "Amkette " },
  { id: 112, brandName: "Angelbird" },
  { id: 90, brandName: "Apple" },
  { id: 100, brandName: "Axcess" },
  { id: 41, brandName: "Bajaj" },
  { id: 67, brandName: "Benro" },
  { id: 104, brandName: "Big Stuff" },
  { id: 37, brandName: "Boat" },
  { id: 23, brandName: "Canon" },
  { id: 58, brandName: "Carvaan" },
  { id: 35, brandName: "Casio" },
  { id: 75, brandName: "Cello" },
  { id: 42, brandName: "Conekt" },
  { id: 60, brandName: "Creative" },
  { id: 109, brandName: "Cuely" },
  { id: 54, brandName: "Dell" },
  { id: 28, brandName: "Digitek" },
  { id: 76, brandName: "DJI" },
  { id: 59, brandName: "Dlink" },
  { id: 73, brandName: "Dolgix" },
  { id: 94, brandName: "Envie" },
  { id: 63, brandName: "Fastrack" },
  { id: 114, brandName: "FeiyuTech" },
  { id: 85, brandName: "Fireboltt" },
  { id: 36, brandName: "Foxin" },
  { id: 32, brandName: "Fuji" },
  { id: 106, brandName: "Gitzo" },
  { id: 57, brandName: "Godox" },
  { id: 105, brandName: "GOPRO" },
  { id: 81, brandName: "Gptrek" },
  { id: 69, brandName: "Hako" },
  { id: 107, brandName: "Harison" },
  { id: 47, brandName: "Havells" },
  { id: 86, brandName: "Hero" },
  { id: 46, brandName: "Hindware" },
  { id: 34, brandName: "Hitachi" },
  { id: 30, brandName: "Hoya" },
  { id: 52, brandName: "HP" },
  { id: 115, brandName: "H&Y" },
  { id: 48, brandName: "Infinity" },
  { id: 18, brandName: "Jagdamba" },
  { id: 38, brandName: "JBL" },
  { id: 19, brandName: "Jealiot" },
  { id: 21, brandName: "Kamron" },
  { id: 29, brandName: "Kodak" },
  { id: 116, brandName: "Lexar" },
  { id: 44, brandName: "LG" },
  { id: 51, brandName: "Logitech" },
  { id: 88, brandName: "Manfrotto " },
  { id: 77, brandName: "Master" },
  { id: 101, brandName: "Maxima" },
  { id: 31, brandName: "Meco" },
  { id: 45, brandName: "MI" },
  { id: 70, brandName: "Mirfak" },
  { id: 97, brandName: "Mobius" },
  { id: 110, brandName: "Morphy" },
  { id: 79, brandName: "Moza" },
  { id: 72, brandName: "MSI" },
  { id: 84, brandName: "Newell" },
  { id: 16, brandName: "Nikon" },
  { id: 71, brandName: "Nisi" },
  { id: 82, brandName: "Noise" },
  { id: 40, brandName: "Nokia" },
  { id: 91, brandName: "Oak" },
  { id: 95, brandName: "Odeo" },
  { id: 56, brandName: "Odio" },
  { id: 108, brandName: "Omax" },
  { id: 61, brandName: "Omron" },
  { id: 20, brandName: "Panasonic" },
  { id: 113, brandName: "Pentax" },
  { id: 25, brandName: "Philips" },
  { id: 26, brandName: "Photron" },
  { id: 102, brandName: "Power Smart" },
  { id: 27, brandName: "Prestige" },
  { id: 80, brandName: "Prograde" },
  { id: 49, brandName: "Quantum" },
  { id: 68, brandName: "Quickheal" },
  { id: 39, brandName: "Realme" },
  { id: 65, brandName: "Rohs" },
  { id: 33, brandName: "Samsung" },
  { id: 119, brandName: "Samyang" },
  { id: 22, brandName: "Sandisk" },
  { id: 99, brandName: "Sigma" },
  { id: 117, brandName: "Simpex" },
  { id: 64, brandName: "Sonata" },
  { id: 24, brandName: "Sony" },
  { id: 66, brandName: "Sunflame" },
  { id: 96, brandName: "Swiss " },
  { id: 43, brandName: "Symphony" },
  { id: 50, brandName: "Syska" },
  { id: 87, brandName: "Tagg" },
  { id: 78, brandName: "Tamron" },
  { id: 62, brandName: "Titan" },
  { id: 17, brandName: "Vanguard" },
  { id: 98, brandName: "Viltrox" },
  { id: 89, brandName: "Wildcraft" },
  { id: 55, brandName: "Yamaha" },
  { id: 118, brandName: "Zeconic" },
  { id: 103, brandName: "Zhiyun" }
];
