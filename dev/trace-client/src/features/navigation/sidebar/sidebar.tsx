...
function Sidebar() {
    ...
    return (
        <div className={clsx(getSidebarClassName(),'transition-[width] duration-500 ease-in-out overflow-auto')}>
            <div className={clsx("h-full w-max flex flex-col bg-neutral-100")}>
                {/* SideBar Header */}
