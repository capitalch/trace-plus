...
export function useProductsBranchTransferLineItems() {
    ...
    return ({ errorIndicatorAndTooltipForProductId, errorIndicatorAndTooltipForQty, errorIndicatorAndTooltipForSerialNumber, getSnError, handleDeleteRow, handleProductClear, handleProductSearch, populateProductOnProductCode, validateSerialNumbers });
}
