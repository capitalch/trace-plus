...
export function ReportAllTransactionsFilterBar() {
    ...
    // const [filters, ] = useState<AllTransactionsFilterType>({
    //     transactionType: "All",
    ...
    return (<div className="flex items-center">
        ...
        <button onClick={handleSetFilter} className="bg-violet-600 text-white rounded-md px-4 py-1">Set filter</button>
            ...
            <div className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded">
                ...
                <span className="text-indigo-600 font-medium">{dateType}</span>
            </div>

            {/* Start Date */}
            <div className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded">
                <span className="text-gray-500">Start Date:</span>
                <span className="text-indigo-600 font-medium">{startDate || "N/A"}</span>
            </div>

            {/* End Date */}
            <div className="flex items-center gap-1 bg-gray-100 px-2 py-1 rounded">
                <span className="text-gray-500">End Date:</span>
                <span className="text-indigo-600 font-medium">{endDate || "N/A"}</span>
            </div>
        </div>
    </div>)
