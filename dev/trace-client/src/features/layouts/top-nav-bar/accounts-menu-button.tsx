...
function AccountsMenuButton({ className }: { className?: string }) {
    ...
    return (<button className={clsx(className, clsName, 'px-10 py-2 text-gray-200 hover:text-white hover:bg-primary-700 hover:cursor-pointer active:bg-primary-400')}>
        Accounts
    </button>)
}
