...
function RolesIcon(props:string) {
    return (
        <svg className={clsx("w-4 h-4 text-primary-500 dark:text-white", props)} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
