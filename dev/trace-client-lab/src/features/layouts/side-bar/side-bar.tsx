...
function SideBar() {
    ...
    return (
        <aside
            className={clsx(
                'fixed xl:static top-0 left-0 h-screen border-r border-neutral-200 z-50',
                'flex flex-col transition-all duration-500 ease-in-out',
                isSideBarOpen ? 'w-[220px] translate-x-0 bg-neutral-50' : 'w-0 -translate-x-full xl:translate-x-0 xl:border-0 bg-transparent',
                'overflow-hidden'
            )}
        >
            {/* Sidebar Header */}
