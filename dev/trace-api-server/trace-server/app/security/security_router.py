...
# from .security_helper import login_helper
...
async def resolve_test():
    raise AppHttpException(error_code='e1000', message='This is a test exception', status_code=401, detail='This is a test detail')
    # raise ValueError("This is a ValueError exception")
    # return {'status': 'test'}
    
@securityRouter.post('/test')
async def resolve_test():
    raise AppHttpException(error_code='e1020', message='This is a test exception', status_code=401, detail='This is a test detail')
