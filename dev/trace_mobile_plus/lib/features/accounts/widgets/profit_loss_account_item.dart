...
class ProfitLossAccountItem extends StatefulWidget {
  final AccountModel account;
  final int depth;
  final int rowIndex;

  const ProfitLossAccountItem({
    super.key,
  ...
  @override
  State<ProfitLossAccountItem> createState() => _ProfitLossAccountItemState();
}

class _ProfitLossAccountItemState extends State<ProfitLossAccountItem> {
